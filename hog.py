...
def swine_align(player_score, opponent_score):
    ...
    rem = player_score % opponent_score
    while rem != 0:
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def say(player0_score, player1_score, running_high=running_high):
        if not who:
            if player0_score - last_score > running_high:
                running_high = player0_score - last_score
                print('{} point(s)! The most yet for Player {}'.format(player0_score - last_score, who))
            return announce_highest(who, player0_score, running_high)
        else:
            if player1_score - last_score > running_high:
                running_high = player1_score - last_score
                print('{} point(s)! The most yet for Player {}'.format(player1_score - last_score, who))
            return announce_highest(who, player1_score, running_high)
